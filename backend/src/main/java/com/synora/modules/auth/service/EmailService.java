...
public class EmailService {
    ...
    public void sendEmailVerification(String toEmail, String token) {
        ...
        String html = """
                <div style="font-family:Inter,sans-serif;max-width:480px;margin:0 auto;padding:32px;background:#0A0A0B;color:#EDEDEF;border-radius:12px;">
                  ...
                  <p style="color:#8B8B8E;">Welcome to Synora! Confirm your email address to activate your account.<br>This link expires in <strong style="color:#EDEDEF;">24 hours</strong>.</p>
                  <a href="%s"
                  ...
                  <p style="color:#5C5C63;font-size:12px;">If you didn't sign up for Synora, ignore this email.</p>
                  <hr style="border:none;border-top:1px solid #222228;margin:24px 0;">
                  <p style="color:#5C5C63;font-size:11px;margin:0;">Synora · %s</p>
                </div>
                """.formatted(verifyUrl, baseUrl);
        send(toEmail, "Verify your Synora email", html);
    }
    ...
    public void sendPasswordReset(String toEmail, String token) {
        ...
        send(toEmail, "Reset your Synora password", html);
    }
