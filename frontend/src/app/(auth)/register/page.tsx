    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-primary px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-content-secondary mt-1">Join the Synora developer community</p>
        </div>
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3 top-[38px] text-content-tertiary hover:text-content-secondary transition-colors"
            >
                  ...
                  <div key={rule.label} className="flex items-center gap-2 text-xs">
                    <div
                      className={cn(
                        ...
                        passed ? 'bg-success' : 'bg-surface-tertiary',
                      )}
                    >
                      <Check size={10} className={passed ? 'text-white' : 'text-content-tertiary'} />
                    </div>
                    <span className={passed ? 'text-content-secondary' : 'text-content-tertiary'}>
                      {rule.label}
                    </span>
                  </div>
                );
          ...
          <label className="flex items-start gap-2 text-sm text-content-secondary cursor-pointer">
            <input
              type="checkbox"
              required
              className="w-4 h-4 mt-0.5 rounded border-border bg-surface-input accent-accent"
            />
            <span>
              I agree to the{' '}
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-xs text-content-tertiary">or continue with</span>
          <div className="flex-1 h-px bg-border" />
        </div>
